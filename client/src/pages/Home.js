...
class Home extends Component {
    ...
    saveGoogleBook = currentBook => {
        console.log("This is the book you  searched for", currentBook);
        API.saveBook({
            id: currentBook.id,
        ...
        .then(res => console.log("Successful POST to Database!", res))
        .catch(err => console.log("Resulting error is", err));
    }
